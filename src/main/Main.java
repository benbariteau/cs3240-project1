...
public class Main {
	...
	/**
	 * A class that acts as the driver of the program
	 * 
	 * @args	Input parameters. arg[0] is the grammar and arg[1] is the input file.
	 */
	...
	/*
	 * Converts a string input to a list of symbol objects
	 */
	...
	/*
	 * Creates a parse table from a list of rules
	 */
	...
	private static List<Rule> createRegexRules() {
		...
		char[] printableAscii = { ' ', '!', '\"', '#', '$', '%', '&', '\'', '(', ')', '*', '+', ',', '-', '.', '/', '0', '1', '2', '3', '4', '5', '6', '7',
	...
	/*
	 * Get list of characters from input set
	 */
	...
	/*
	 * Get list of characters from input set if contained in both input sets
	 */
	...
	/*
	 * Convert a character to a terminal
	 */
